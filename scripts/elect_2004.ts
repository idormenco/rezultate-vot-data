...
async function processRound1Data() {
  ...
  const {
    ...
    ROUND_ONE_ID,
    "./data/elect_2004/xp1_processed.csv",
    candidatesVarLookupRound1
  );

  await fs.writeFile(
    "data/elect_2004/output/round_1_data.sql",
    [
      ...partyInsertsRound1,
  ...
  await fs.writeFile(
    "data/elect_2004/output/tur_1_votes.csv",
    stringify(votesDataTur1, { header: true }),
    "utf8"
  );
  await fs.writeFile(
    "data/elect_2004/output/tur_1_records.csv",
    stringify(recordsDataTur1, { header: true }),
    "utf8"
  );
  await fs.writeFile(
    "data/elect_2004/output/tur_1_turnouts.csv",
...
async function processRound2Data() {
  ...
  const {
    ...
    ROUND_TWO_ID,
    "./data/elect_2004/xp2_processed.csv",
    candidatesVarLookupRound2
  );

  await fs.writeFile(
    "data/elect_2004/output/round_2_data.sql",
    [
      ...partyInsertsRound2,
  ...
  await fs.writeFile(
    "data/elect_2004/output/tur_2_votes.csv",
    stringify(votesDataTur2, { header: true }),
    "utf8"
  );
  await fs.writeFile(
    "data/elect_2004/output/tur_2_records.csv",
    stringify(recordsDataTur2, { header: true }),
    "utf8"
  );
  await fs.writeFile(
    "data/elect_2004/output/tur_2_turnouts.csv",
...
async function processElectionData() {
  ...
  await fs.mkdir("data/elect_2004/output", { recursive: true });
